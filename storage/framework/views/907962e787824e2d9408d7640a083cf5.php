    ...
    <div class="col-md-3" >
        <form action="<?php echo e(route('course-students.update',  $courseStudent->id)); ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" name="amount_paid"  value="<?php echo e($courseStudent->amount_paid); ?>"  id="amount_paid" class="form-control"style="width: 300px;" >
            </div>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="date" name="start_date" id="start_date"value="<?php echo e($courseStudent->start_date); ?>" class="form-control" style="width: 300px; height: 40px;">
            </div>
            <div class="form-group">
                <label for="end_date">End Date</label>
                <input type="date" name="end_date" id="end_date" value="<?php echo e($courseStudent->end_date); ?>" class="form-control" style="width: 300px; height: 40px;">
            </div>
