    ...
    <div class="col-md-3" >
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="date" name="start_date" id="start_date" min="<?php echo e($course->start_date); ?>" class="form-control" style="width: 300px; height: 40px;">
            </div>
            <div class="form-group">
                <label for="end_date">End Date</label>
                <input type="date" name="end_date" id="end_date" class="form-control" style="width: 300px; height: 40px;">
...
<script>
    $(document).ready(function() {
        ...
        if (student && amount_paid && start_date && end_date  ) {
